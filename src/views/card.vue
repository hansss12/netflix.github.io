                ...
                <div class="card-form__inner">
                    <form @submit.prevent="submitCard">
                        ...
                        <button
                            ...
                            "
                        >
                            {{ dataCard ? "Card Information" : "Submit" }}
                        </button>
                    </form>
                </div>
            </div>
...
export default {
    ...
    computed: {
        ...mapState(useMovieStore, ["dataCard"]),
        getCardType() {
    ...
    watch: {
        dataCard(value) {
            ...
            this.cardName = value.holder;
            this.cardMonth = value.month;
            this.cardYear = value.year;
            this.cardCvv = value.cvv;
        },
        cardYear() {
    ...
    methods: {
        ...mapActions(useMovieStore, ["card", "addCard"]),
        submitCard() {
            this.addCard(
                this.cardNumber,
                this.cardName,
