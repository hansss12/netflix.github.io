<template>
    ...
    <div class="movies-container favorites">
        <div class="movies-grid">
            <div v-for="data in tmdbSearch" class="card">
                <RouterLink
                    style="text-decoration: none; color: white"
                    :to="`/upcoming/tmdb/${data.id}`"
                >
                    <div class="img">
    ...
    <div class="movies-container trending">
        <h1>Upcoming</h1>
        <div class="movies-grid">
            <div v-for="data in tmdbTrending" class="card">
                <RouterLink
                    style="text-decoration: none; color: white"
                    :to="`/upcoming/tmdb/${data.id}`"
                >
...
export default {
    ...
    methods: {
        ...
        searching() {
            this.movieBySearch(this.search);
        },
    },
    computed: {
